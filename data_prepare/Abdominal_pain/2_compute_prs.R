...
library(bigreadr)
library(data.table)
folder = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Abdominal_pain/'
sumstats <- fread2("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Abdominal_pain/GCST90479148_GRCh37.txt.gz", select = c(1,23,3,4,5,8))
...
max(grid2$auc)  # 0.5049287
min(grid2$auc)  # 0.4951145
