...
library(bigreadr)
library(data.table)
folder = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Atrial_fibrillation/'
sumstats <- fread2("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Atrial_fibrillation/GCST90475967_GRCh37.txt.gz", select = c(1,23,3,4,5,8))
...
max(grid2$auc)  # 0.622262
min(grid2$auc)  # 0.527725
