...
library(bigreadr)
library(data.table)
folder = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Coronary_atherosclerosis/'
sumstats <- fread2("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Coronary_atherosclerosis/GCST90475936_GRCh37.txt.gz", select = c(1,23,3,4,5,8))
...
max(grid2$auc)  #0.6073999
min(grid2$auc)  #0.5301455
