...
library(bigreadr)
library(data.table)
folder = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Diaphragmatic_hernia/'
sumstats <- fread2("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Diaphragmatic_hernia/GCST90476061_GRCh37.txt.gz", select = c(1,23,3,4,5,8))
...
max(grid2$auc)  # 0.540537
min(grid2$auc)  # 0.5062866
