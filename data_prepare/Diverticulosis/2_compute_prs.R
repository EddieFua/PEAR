...
library(bigreadr)
library(data.table)
folder = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Diverticulosis/'
sumstats <- fread2("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Diverticulosis/GCST90476076_GRCh37.txt.gz", select = c(1,23,3,4,5,8))
...
max(grid2$auc)  # 0.5763916
min(grid2$auc)  # 0.5176872
