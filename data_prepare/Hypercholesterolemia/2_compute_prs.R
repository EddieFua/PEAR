...
library(bigreadr)
library(data.table)
folder = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Hypercholesterolemia/'
sumstats <- fread2("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/Hypercholesterolemia/GCST90475721_GRCh37.txt.gz", select = c(1,23,3,4,5,8))
colnames(sumstats)
...
max(grid2$auc)  # 0.5633359
min(grid2$auc)  # 0.5193232
