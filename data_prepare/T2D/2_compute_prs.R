...
library(bigreadr)
library(data.table)
folder = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/'
sumstats <- fread2("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/METAANALYSIS_DIAGRAM_SE1.txt", select = c(1:4, 6))
...
library(bigreadr)
load('/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/feature.RData')
table(y)
####     0      1 
####383243  16470
...
X <- X[eid %in% sub_eid]
saveRDS(y, file = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/ukb_final_y.rds')
saveRDS(X, file = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/ukb_final_X.rds')
...
rds <- bigsnpr::snp_readBGEN(
  ...
  ind_row = sub_id,
  backingfile = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/imppgen_qc_unrelated_final',
  ncores = NCORES)
)#149s


library(bigsnpr)
ukbb <- snp_attach("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/imppgen_qc_unrelated_final.rds")
G <- ukbb$genotypes
...
saveRDS(all_keep, file = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/all_keep.rds')
system.time(
  multi_PRS <- snp_grid_PRS(
    G, all_keep, betas = beta, lpS = lpval, ind.row = rows_along(G),
    n_thr_lpS = 50, backingfile = "/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/UKBB_scores", ncores = NCORES)
) # 226s
saveRDS(multi_PRS, file = '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/multi_PRS.rds')


all_keep <- readRDS('/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/all_keep.rds')
multi_PRS <- readRDS('/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/multi_PRS.rds')
...
dim(multi_PRS_mat)
npySave("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/multi_PRS.npy", multi_PRS_mat)
y = readRDS('/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/ukb_final_y.rds')
ids <- names(y)
write.table(
  ids,
  file = "/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/ukb_final_ids.txt",
  row.names = FALSE,
  col.names = FALSE,
  quote = FALSE
)
npySave("/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/ukb_final_y.npy", as.matrix(y))
features <- readRDS('/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/ukb_final_X.rds')
features <- features[,-1]
npySave('/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/ukb_final_features.npy', as.matrix(features))
...
write.csv(semantic, '/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/semantic.csv', row.names = FALSE)
...
head(covariates)
head(y)
npySave('/home/yinghaofu2/augmented_prs/data_prepare/clean_data/T2D/ukb_final_covariates.npy', as.matrix(covariates[, -1]))
